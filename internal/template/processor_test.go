...
func TestBuildTemplateVars(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			fullImageName: "registry.example.com:5000/my-app:v1.0.0",
			imageTag:      "v1.0.0",
			imageDigest:   "sha256:abc123",
			expectedVars: TemplateVars{
				ImageTag:          "v1.0.0",
				...
				ServiceName:       "my-app",
				K8sCompatibleName: "my-app",
				Variables:         nil,
			},
			expectError: false,
		},
		{
			name:          "Generic registry URL with scheme",
			fullImageName: "http://172.19.0.5:5000/test-app:v2.0.0",
			imageTag:      "v2.0.0",
			imageDigest:   "",
			expectedVars: TemplateVars{
				ImageTag:          "v2.0.0",
				...
				Registry:          "172.19.0.5:5000",
				ServiceName:       "test-app",
				K8sCompatibleName: "test-app",
				Variables:         nil,
			},
			expectError: false,
		},
		{
			...
			fullImageName: "my-service:latest",
			imageTag:      "latest",
			imageDigest:   "sha256:abc123",
			expectedVars: TemplateVars{
				ImageTag:          "latest",
