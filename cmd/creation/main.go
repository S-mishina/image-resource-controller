...
// Package main is the entrypoint for the resource creation controller.
package main
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "resource-creation.gitops.io",
	...
	setupLog.Info("starting Resource Creation Controller")
